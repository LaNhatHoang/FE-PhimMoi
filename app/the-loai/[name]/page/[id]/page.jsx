...
const getPhim = async(baseUrl, paramName, idPage)=>{
    const ctg = paramName.replaceAll("-", "")
    const res = await fetch(`${baseUrl}/category/${ctg}/page/${idPage}/30`)
    return res.json()
}
...
const Page = async({params})=>{
    ...
    const nameCategory = getNameCategory(decodeURIComponent(params.name), categorys)
    return(
